                                    ...
                                    <Form action="/changeProfile1" method="post" encType="multipart/form-data">
                                        <div className="row">
                                            <div className="col-md-8">
                                                <input type="hidden" id="emailOfChaneProfile" value="<%=doc.email%>" name="email"></input>
                                
                                                <Form.Group>
                                                    <Form.Label>Họ</Form.Label>
                                                    <Form.Control type="text" value="<%=doc.fullname%>" />
                                                </Form.Group>
                                                <Form.Group>
                                            ...
                                            <div className="col-md-4">
                                                ...
                                                <div className="text-center">
                                                    <img alt="Chris Wood" src="<%=doc.picture%>" width="128" height="128"></img>
                                                    <div className="mt-2">
